export default function CvPreview(props) {
  ...
  return (
    <div className="flex justify-center items-center h-a4 w-a4 scale-[0.4] sm:md:scale-[0.7] md:lg:scale-[0.8] lg:xl:scale-[0.9] overflow-hidden origin-top shadow-md shadow-slate-400 mt-2 min-height-screen">
